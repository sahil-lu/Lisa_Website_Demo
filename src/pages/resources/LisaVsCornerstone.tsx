      ...
      <main className="pt-20">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-gray-50 rounded-2xl p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Cornerstone (at a glance)</h3>
                  <p className="text-gray-700">Enterprise LMS inside a bigger HR/talent stack; tends to run like a large IT project and pricing is typically quote-based.</p>
                </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-12 text-center">
                Why teams switch from Cornerstone to Lisa
              </h2>
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600">Cornerstone</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">Enterprise-style projects</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">Depends on setup/customization</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">Enterprise reporting (admin-led)</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">White-labeling varies by package</td>
                      </tr>
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">Enterprise connectors (IT-led)</td>
                      </tr>
                      <tr>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-sm text-gray-600">
                Cornerstone is a registered trademark of its respective owner. This page is for comparative purposes to help buyers evaluate learning platforms.
              </p>
            </div>
          </div>
        </section>
...
export default LisaVsCornerstone;