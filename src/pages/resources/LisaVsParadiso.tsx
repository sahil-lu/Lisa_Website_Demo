      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center justify-between mb-12">
                ...
                {/* Paradiso Logo - Right Side */}
                <div className="flex-1 flex justify-center">
                  <img 
                    src="/logos/paradisssso.png" 
                    alt="Paradiso Logo" 
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-gray-50 rounded-2xl p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Paradiso (at a glance)</h3>
                  <p className="text-gray-700">Traditional LMS with many toggles and project-style setup; pricing and time-to-value vary by module bundle.</p>
                </div>
                <div className="bg-purple-50 rounded-2xl p-8 border-2 border-purple-200">
                  <h3 className="text-2xl font-bold text-purple-900 mb-4">Lisa (the better fit for most teams)</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span>BI-Ready – Power BI / Tableau connectors</span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-12 text-center">
                Why teams switch from Paradiso to Lisa
              </h2>
            ...
            <div className="max-w-6xl mx-auto">
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600">Paradiso</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">BYO library / marketplace</td>
                      </tr>
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">Requires admin configuration</td>
                      </tr>
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">Quizzes/assignments; add-ons vary</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-green-600">Manager dashboards + BI connectors (Power BI/Tableau)</td>
                      ...
                      <tr>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">Catalog of connectors</td>
                      </tr>
                      <tr>
              ...
              <div className="mt-8 p-6 bg-purple-50 rounded-2xl border border-purple-200">
                <p className="text-lg font-semibold text-purple-900 text-center">
                  Bottom line: With Lisa you start strong on day one—library, JIT, AI practice, nudges, analytics—without wrestling a heavy setup.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-gray-700">SSO/HRMS connect, brand the web + apps, enable reporting connectors.</p>
                </div>
